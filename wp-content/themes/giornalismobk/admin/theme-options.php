...
function giornalismo_home_customizer( $wp_customize ) {
	...
	$wp_customize->add_setting(
		'giornalismo-column-four-category',
		array(
			'default'           => 'None',
			'sanitize_callback' => 'giornalismo_sanitize_category',
		)
	...
	$wp_customize->add_control(
		'giornalismo-column-four-category',
		array(
			'label'     => __( 'Column four Category', 'giornalismo' ),
			'section'   => 'home',
			'type'      => 'select',
			'choices'   => $cat_args
		)
	...
	//* Number of Column Four Stories
	$wp_customize->add_setting(
		'giornalismo-column-four-count',
		array(
			'default'           => '6',
			'sanitize_callback' => 'giornalismo_sanitize_num',
		)
	...
	$wp_customize->add_control(
		'giornalismo-column-four-count',
		array(
			'label'     => __(  'Number of Stories in the fourth Column', 'giornalismo'  ),
			'section'   => 'home',
			'type'      => 'text',
		)
	);
